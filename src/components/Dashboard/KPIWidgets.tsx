          ...
          <div className="space-y-1">
            ...
            {AVAILABLE_KPI_METRICS.filter(m => !draft.includes(m)).map(metric => (
              <button
                ...
                className="w-full flex items-center gap-2 px-2 py-1.5 rounded bg-gray-800/50 border border-gray-700/50 text-left hover:bg-gray-700/50 disabled:opacity-40 disabled:cursor-not-allowed"
              >

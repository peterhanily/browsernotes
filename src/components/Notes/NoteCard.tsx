    ...
    >
      {onTrash && !note.trashed && (
        <button
          ...
          className="absolute top-2 left-2 p-1 rounded text-red-500 hover:text-red-400 hover:bg-gray-700 opacity-40 group-hover:opacity-100 transition-opacity z-10"
          title="Move to trash"

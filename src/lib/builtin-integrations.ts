...
export const BUILTIN_INTEGRATIONS: IntegrationTemplate[] = [
  ...
  // ── 7. Shodan InternetDB (free, no API key) ──────────────────────────
  {
    ...
    description: 'Free IP enrichment from Shodan — open ports, CVEs, hostnames, and tags. No API key required.',
    author: 'ThreatCaddy',
    icon: 'globe',
    color: '#D32020',
    category: 'enrichment',
  ...
  // ── 8. VirusTotal Domain Lookup ──────────────────────────────────────
  {
    ...
    description: 'Look up a domain on VirusTotal for reputation, DNS records, and analysis statistics.',
    author: 'ThreatCaddy',
    icon: 'shield-check',
    color: '#394EFF',
    category: 'enrichment',
  ...
  // ── 9. VirusTotal Hash Lookup ────────────────────────────────────────
  {
    ...
    description: 'Look up a file hash (MD5/SHA1/SHA256) on VirusTotal for malware detection results.',
    author: 'ThreatCaddy',
    icon: 'shield-check',
    color: '#394EFF',
    category: 'enrichment',
  ...
  // ── 10. ThreatFox IOC Search ─────────────────────────────────────────
  {
    ...
    description: 'Search ThreatFox (abuse.ch) for known malware-associated IOCs — C2 servers, distribution URLs, payload hashes.',
    author: 'ThreatCaddy',
    icon: 'bug',
    color: '#f59e0b',
    category: 'enrichment',
  ...
  // ── 11. MalwareBazaar Hash Lookup ────────────────────────────────────
  {
    ...
    schemaVersion: '1.0',
    version: '1.0.0',
    name: 'MalwareBazaar Hash Lookup',
    description: 'Look up a file hash on MalwareBazaar (abuse.ch) — known malware samples, signatures, tags, and vendor intel.',
    author: 'ThreatCaddy',
    icon: 'file-warning',
    color: '#dc2626',
    category: 'enrichment',
  ...
  // ── 12. GreyNoise Community ──────────────────────────────────────────
  {
    ...
    description: 'Classify an IP as benign, malicious, or unknown using GreyNoise. Identifies known scanners, bots, and trusted services.',
    author: 'ThreatCaddy',
    icon: 'radio',
    color: '#10b981',
    category: 'enrichment',
    ...
    configSchema: [
      {
        key: 'apiKey',
        label: 'API Key',
        description: 'Your GreyNoise Community API key (free at greynoise.io)',
        type: 'password',
        required: true,
      },
    ],
